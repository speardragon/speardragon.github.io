...
- A program resides on a disk as a binary executable file 
  ...
  - Input queue – collection of processes on the disk that are waiting to  be brought into memory for execution. 
    - Select one of the processes in input queue, load that process  into memory 
...
![image-20221002233403794](https://raw.githubusercontent.com/speardragon/save-image-repo/main/img/image-20221002233403794.png)
...
- Internal address는 pass1,2를 통하여 reconcile됨. 
