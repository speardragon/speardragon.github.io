...
with weigh function ![image](https://user-images.githubusercontent.com/79521972/170176160-90ec4724-0977-4ee6-8986-272a5c5ce0ee.png) mapping edges to real-valued weights. 

The weight w(p) of path ![image](https://user-images.githubusercontent.com/79521972/170176223-bae160b8-1367-44f5-8b69-42d7995b530d.png) is the sum of the weights of its constituent edges:
...
Given a graph G = (V, E), we maintain for each vertex v ∈ V a predecessor v.*π* that is is either another vertex of NIL.
...
Each algorithm in the chapter calls Initialize-single-source and then repeatedly relaxes edges. Moreover, relaxation is the only means by which shortest-path estimates and predecessors change. 

The algorithms in the chapter differ in how many times they relax each edge and the order in which they relax edges. Dijkstra's algorithm and the shortest-paths algorithm for directed acyclic graphs relax each edge exactly once. 
...
![image](https://user-images.githubusercontent.com/79521972/170178197-052548ac-613f-41c7-8a58-873ae18e7565.png)
...
check, dist, pre = bellman_ford(Fig24_4, 's') # 35
if check:
    print(pre)
    print(dist)
```
